...
const PauseField = ({ error, control }: Props) => {
  ...
  useEffect(() => {
    setValue(formState.defaultValues?.pause || 0);
  }, [formState.defaultValues]);

  return (
    <>
      <label htmlFor="pause" className="mt-4 block text-xs font-semibold uppercase text-gray-600">
        Стоянка (час)
      </label>
